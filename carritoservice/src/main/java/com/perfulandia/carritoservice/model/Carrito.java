...
public class Carrito {
    ...
    public void addItem(CarritoItem item) { this.items.add(item); item.setCarrito(this); }
    public void removeItemByProductoId(Long productoId) { this.items.removeIf(item -> item.getProductoId().equals(productoId)); }
